...
`
SELECT * FROM information_schema.columns WHERE table_name =$1::text
`
    /**
     * @todo fix error : function to_regclass does not exist
     */
    const SELECT_COLUMNS_SQL_TO_FIXED_BUG = 
`
SELECT
...
module.exports = class PostgreSQLType extends AbstractServer{
     ...
     * @param {string|undefined} [database=undefined]
     ...
     */
    changeDatabase (name) {
        console.log("changeDatabase", name);
                        ...
                        this.queryPromise(SELECT_COLUMNS_SQL, columnParams).then((column) => {
                            ...
                            for (var i = 0; i < column.length; i++) {
                                ...
                                columns.push({
                                    ...
                                    Default : element.column_default,
                                });
                            }
                            resolve({
                                column : columns,
